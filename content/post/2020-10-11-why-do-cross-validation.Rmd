...
![evaluation set approach](/post/2020-10-11-why-do-cross-validation_files/Screenshot 2020-10-11 105549.png)

In Python, this is what we do when we run the infamous `train_test_split()` function from `sklearn`:
...
![train, validation, holdout](/post/2020-10-11-why-do-cross-validation_files/Screenshot 2020-10-11 105453.png)

This is not exactly feasible because:
...
![5-fold cross-validation](/post/2020-10-11-why-do-cross-validation_files/Screenshot 2020-10-11 105633.png)
...
**None of the above!** The purpose of cross-validation is merely to pick the correct procedure for fitting a model. Whether it be the algorithm, the hyperparameter search space, the purpose of cross-validation is to know what procedure works best for your data. The same procedure can be reused to re-fit the model on new data, and that should make up your final model.
